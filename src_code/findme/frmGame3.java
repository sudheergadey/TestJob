...
public class frmGame3 extends  JFrame
{
	...
	JLabel lbl3=new JLabel("Toy");
	JLabel lbl4=new JLabel("Lips");
	JLabel lbl5=new JLabel("Vaccum");
	JLabel lbl6=new JLabel("Old picture");
	JLabel lbl7=new JLabel("Battery");
	JLabel lbl8=new JLabel("Axe");
	...
	JLabel lblGamePic=new JLabel(new ImageIcon(path + "gawas.gif"));
	JLabel lblSPic=new JLabel(new ImageIcon (path + "ghost_animated.gif"));
	JLabel lblPic1=new JLabel(new ImageIcon (path + "vaccum.gif"));
	JLabel lblPic2=new JLabel(new ImageIcon (path + "battery.gif"));
	...
	JLabel lblPic8=new JLabel(new ImageIcon (path + "Axe.gif"));
	...
	public frmGame3()
	{
		...
		lblPic1.setBounds(450,180,50,200);
		lblPic2.setBounds(50,250,90,20);
		lblPic3.setBounds(300,100,30,30);
		lblPic4.setBounds(200,200,40,55);
		lblPic5.setBounds(350,200,40,40);
		lblPic6.setBounds(50,300,60,40);
		lblPic7.setBounds(210,130,30,20);
		lblPic8.setBounds(420,220,45,140);
		...
		lbl4.setBounds(30,40,140,20);
		lbl7.setBounds(30,60,140,20);
		
		lbl2.setBounds(250,20,140,20);
		lbl5.setBounds(250,40,140,20);
		lbl8.setBounds(250,60,140,20);
		
		lbl3.setBounds(350,20,140,20);
		lbl6.setBounds(350,40,140,20);
		lbl9.setBounds(350,60,140,20);
		...
		lblPic1.addMouseListener(new MouseAdapter()
		{
			public void mouseClicked(MouseEvent e)
			{
	            ...
	            if (handlerAns.getText().equals("9"))
	            {
	            	...
	            	frmWin3 win=new frmWin3(); win.setVisible(true);
