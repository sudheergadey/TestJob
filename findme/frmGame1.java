...
public class frmGame1 extends  JFrame
{
	...
	JLabel lbl5=new JLabel("Butterfly");
	...
	JLabel lblGamePic=new JLabel(new ImageIcon(path + "Bar.gif"));
	JLabel lblSPic=new JLabel(new ImageIcon (path + "ghost_animated.gif"));
	JLabel lblPic1=new JLabel(new ImageIcon (path + "butterfly.gif"));
	...
	public frmGame1()
	{
		...
		lblPic1.setBounds(450,40,20,20);
		lblPic2.setBounds(30,50,90,20);
		lblPic3.setBounds(268,205,30,30);
		lblPic4.setBounds(100,137,40,55);
		lblPic5.setBounds(350,200,40,40);
		lblPic6.setBounds(150,270,60,40);
		...
		lblPic1.addMouseListener(new MouseAdapter()
		{
			public void mouseClicked(MouseEvent e)
			{
	            ...
	            if (handlerAns.getText().equals("9"))
	            {
	            	...
	            	frmWin win=new frmWin(); win.setVisible(true);
